...
public class CPUBranchTests extends CPUTest {
    ...
    public void testBranchNotTaken() {
        ...
        assertAll(
                () -> assertEquals(2, cycles, "a branch that isn't taken should take 2 cycles"),
    ...
    public void testBranchOnSamePage() {
        ...
        int cycles = stepInstruction();  // bcs
        assertAll(
                () -> assertEquals(3, cycles, "a branch on the same page should take 3 cycles"),
    ...
    public void testBranchAcrossPageBoundary() {
        ...
        int cycles = stepInstruction();  // bcs
        assertAll(
                () -> assertEquals(4, cycles, "a branch across a page boundary should take 4 cycles"),
