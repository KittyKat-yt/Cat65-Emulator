...
public class CPUJumpAndStackTests extends CPUTest {
    ...
    public void testJump() {
        ...
        assertAll(
                () -> assertEquals(3, cycles, "an absolute jump should take 3 cycles"),
    ...
    public void testIndirectJump() {
        ...
        loadProgram(
                0x6c, 0x80, 0x02  // jmp ($0280)
        );

        int cycles = stepInstruction();  // jmp
        assertAll(
                () -> assertEquals(6, cycles, "an indirect jump should always take 6 cycles"),
                () -> assertEquals(0x1234, cpu.getPC(), "JMP should move the PC to the correct target address")
        );
    }
    @Test
    ...
    public void testJumpTable() {
        ...
        assertAll(
                () -> assertEquals(6, cycles, "in indirect indexed jump should take 6 cycles"),
                () -> assertEquals(0x1234, cpu.getPC(), "an indirect indexed jump should read and move the PC to the correct target address")
        );
    }
    ...
    public void testSubRoutine() {
        ...
        assertAll(
                () -> assertEquals(6, jsrCycles, "JSR should take 6 cycles"),
        ...
        assertAll(
                () -> assertEquals(6, rtsCycles, "RTS should take 6 cycles"),
    ...
    public void testPushAndPullStatus() {
        ...
        assertAll(
                () -> assertEquals(0x10, pushedP & 0x10, "the B-flag should be pushed as 1 by PHPs"),
        ...
        assertEquals(0xcf, cpu.getP() & 0xcf, "PLP should correctly set the status flags");
    }
    ...
    public void testStackPointerTransfers() {
        ...
        assertAll(
                () -> assertEquals(2, tsxCycles, "TSX should take 2 cycles"),
        ...
        assertAll(
                () -> assertEquals(2, txsCycles, "TXS should take 2 cycles"),
    ...
    public void testStackRegisters() {
        ...
        assertAll(
                () -> assertEquals(0xf5, readStack(2), "the correct A value should've been pushed"),
        ...
        assertAll(
                () -> assertEquals(0xca, cpu.getA(), "the correct value should've been pulled into A"),
