...
public class CPU65c02Tests extends CPUTest {
    ...
    public void testStoreZero() {
        ...
        assertAll(
                () -> assertEquals(3, cycles, "zero-page STZ should take 3 cycles"),
    ...
    public void testTestAndSetBit() {
        ...
        assertAll(
                () -> assertEquals(5, cycles, "TSB should take 5 cycles"),
    ...
    public void testTestAndResetBit() {
        ...
        assertAll(
                () -> assertEquals(5, cycles, "TRB should take 5 cycles"),
    ...
    public void testSetMemoryBit() {
        ...
        assertAll(
                () -> assertEquals(5, cycles, "SMB- should take 5 cycles"),
    ...
    public void testResetMemoryBit() {
        ...
        assertAll(
                () -> assertEquals(5, cycles, "RMB- should take 5 cycles"),
    ...
    public void testBranchOnBitReset() {
        ...
        loadProgram(
                0x2f, 0x80, 7  // bbr2 $80, +7 (not taken)
        );
    ...
    public void testBranchAlways() {
        ...
        assertAll(
                () -> assertEquals(3, cycles, "BRA on the same page should take 3 cycles"),
    ...
    public void testAccumulatorIncrementAndDecrement() {
        ...
        assertAll(
                () -> assertEquals(2, incCycles, "INC A should take two cycles"),
                () -> assertEquals(0x21, cpu.getA(), "INC A should correctly add 1 to A")
        );

        int decCycles = stepInstruction();  // dec
        assertAll(
                () -> assertEquals(2, decCycles, "DEC A should take two cycles"),
